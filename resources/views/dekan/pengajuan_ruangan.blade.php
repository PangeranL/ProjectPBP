...
<head>
    ...
    <title>Pengajuan Ruang Kuliah</title>
...
<body class="bg-[#D6EFD8]">
    ...
    <div class=" container mt-3 mx-auto">
        <h1 class="text-3xl text-center font-bold">PENGAJUAN RUANG KULIAH</h1>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-2 flex justify-between items-center mb-2 w-3/4 mx-auto mt-4">
        ...
        <div class="w-1/4 text-center">
            <button onclick="window.location.href='{{ url('/dekan/ruang')}}'"" 
