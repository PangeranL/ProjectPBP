                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <a href="/kaprodi/filter-jadwal?kodeMK={{$value->kodeMK}}" class="bg-green-800 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-full" style="margin-top: 10px">Detail</a>
                        </td>
                    </tr>
                    @empty
                    tidak ada data 
